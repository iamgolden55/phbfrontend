...
import { useOrganizationAuth } from '../../organization/organizationAuthContext';
import {
    LayoutDashboard,
    User,
    Calendar,
    ...
    CheckSquare,
    Building2,
    Briefcase as ProjectIcon, // Alias specifically if needed or just use Briefcase
    DollarSign
} from 'lucide-react';
...
const EmployeeSidebar: React.FC<EmployeeSidebarProps> = ({
    ...
    return (
        <aside
            data-tour="employee-sidebar-nav"
            className={`
