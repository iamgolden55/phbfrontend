...
const RegisterForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateVerificationStep()) {
      ...
      // The register function will set an error message (which is actually a success message)
      // Wait a brief moment to let the user see any success message, then redirect
      setTimeout(() => {
        navigate('/login');
      }, 1500);
    }
