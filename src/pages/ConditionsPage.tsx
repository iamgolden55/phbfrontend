      ...
      <div className="phb-container py-10">
                ...
                <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md group-hover:border-blue-300 h-full">
                  <div className="p-6">
                    <div className="flex items-start mb-4">
                      ...
                      <div className="ml-4">
                        <h3 className="text-xl font-bold text-[#0891b2] mb-2 group-hover:underline">{category.title}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              {quickLinks.map((link, index) => (
                <Link key={index} to={link.path} className="block group">
                  <div className="bg-white p-4 rounded-md shadow-sm hover:shadow-md transition-shadow flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-[#0891b2] mb-1 group-hover:underline">{link.title}</h3>
                      <p className="text-sm text-gray-600">{link.description}</p>
                    </div>
                    <svg className="h-5 w-5 ml-auto text-[#0891b2] transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              {commonConditions.map((condition, index) => (
                <Link key={index} to={condition.path} className="block group">
                  <div className="p-3 rounded-md hover:bg-blue-50 transition-colors flex items-center justify-between">
                    <span className="text-[#0891b2] font-medium group-hover:underline">{condition.name}</span>
                    <svg className="h-4 w-4 text-[#0891b2] transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </div>
                </Link>
            ...
            <div className="mt-6 text-center">
              <Link
                to="/health-a-z"
                className="inline-flex items-center bg-[#0891b2] text-white px-6 py-2 rounded-md hover:bg-[#0e7490] transition-colors"
              >
        ...
        <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-bold mb-4 text-[#0891b2]">Evidence-based content</h3>
            ...
            <div>
              <h3 className="text-lg font-bold mb-4 text-[#0891b2]">Regular updates</h3>
              <p className="text-gray-700 mb-4">
