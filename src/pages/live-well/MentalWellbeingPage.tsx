      ...
      <div className="phb-container py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[#0891b2] mb-4">What is mental wellbeing?</h2>
              <p className="mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[#0891b2] mb-4">5 steps to mental wellbeing</h2>
              <p className="mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-blue-50 p-5 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-[#0891b2]">1. Connect with others</h3>
                  <p>
                ...
                <div className="bg-blue-50 p-5 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-[#0891b2]">2. Be physically active</h3>
                  <p>
                ...
                <div className="bg-blue-50 p-5 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-[#0891b2]">3. Learn new skills</h3>
                  <p>
                ...
                <div className="bg-blue-50 p-5 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-[#0891b2]">4. Give to others</h3>
                  <p>
                ...
                <div className="bg-blue-50 p-5 rounded-lg md:col-span-2">
                  <h3 className="text-xl font-semibold mb-3 text-[#0891b2]">5. Pay attention to the present moment</h3>
                  <p>
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[#0891b2] mb-4">Managing stress</h2>
              <p className="mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[#0891b2] mb-4">Improving sleep for better mental health</h2>
              <p className="mb-4">
              ...
              <p>
                <Link to="/live-well/sleep" className="text-[#0891b2] font-medium hover:underline">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[#0891b2] mb-4">When to seek help</h2>
              <p className="mb-4">
              ...
              <p>
                <Link to="/mental-health" className="text-[#0891b2] font-medium hover:underline">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/mental-health" className="text-[#0891b2] hover:underline flex items-center">
                    <svg className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              ...
              <div className="p-5">
                <h3 className="text-lg font-bold text-[#0891b2] mb-3">Mindfulness guide</h3>
                <p className="text-gray-600 mb-4">
                  Learn the basics of mindfulness and how to incorporate it into your daily life for improved mental wellbeing.
                </p>
                <Link to="/live-well/mental-wellbeing/mindfulness" className="text-[#0891b2] font-medium hover:underline">
                  Explore mindfulness
                </Link>
              </div>
            </div>
